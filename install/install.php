...
<form name='set_form' method='post' action='?step=1'>
  <div class="row-fluid">
    <div class="span12">
      ...
      <select name="lcal">
	  <?php
        $handle = @opendir("../inc/langs/");
	  
        while (false !== ($file = readdir($handle))) {

          if ($file != "." && $file != ".." && $file != "index.html" && $file != "error_log") {
...
<form name='set_form' method='post' action='?step=2'>
  <div>
    <b>Public Key:</b><br />
...
<div style="width:500px;margin-left:auto;margin-right:auto;margin-top:20px;">
  ...
  <p>Here you can set up your RSA keys, these will be used to encrypt your bitcoin keys so even your web host cannot steal your bitcoin keys. The public RSA key is only used to encrypt data, only the private RSA key can decrypt data encrypted with the public key.</p>

  <p>The private RSA key must be stored offline, or for the most security you could write or print it out. When you are viewing an order in the admin panel you will see an option to decrypt the private bitcoin key. The decryption happens client-side with JavaScript.</p>

  <p><b>IMPORTANT:</b> When you choose to decrypt the private bitcoin key attached to an order you will be required to input the private RSA key generated here. If you lose the private RSA key <u>you wont be able to access your BTC</u> because you wont be able to decrypt the bitcoin keys.</p>
  
  <p><b>To ensure that your RSA keypair is working correctly, <b>you should make a test transaction using the testnet or a small amount of BTC</b>. Then decrypt the Bitcoin private key associated to the test transaction to make sure you can access your BTC when you need to cash out.</p>
