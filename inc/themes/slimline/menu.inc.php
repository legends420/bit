		...
		<ul class="nav">
		  ...
		  <li class="dropdown">
			...
			<ul class="dropdown-menu">
              <li class="nav-header"><?php echo LANG('SYSTEM_INFO'); ?></li>
			  <li>
			    <a href='http://bitfreak.info/bitshop/' target="_blank"><?php 
			    echo LANG('BITSHOP'); ?> v<?php echo $bs_version; ?></a>
			  </li><li>
			    <a href='./ticker/<?php safe_echo($json_file); ?>' target="_blank"><?php 
			    echo LANG('EXCHANGE_RATE'); ?> (<?php safe_echo($price_type); ?>):</a>
			  </li><li>
