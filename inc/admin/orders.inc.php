...
<p><a href="admin.php?page=orders" title="Go Back">BACK</a> | <a href="#" title="Delete Order" onClick="delete_tran();">DELETE ORDER</a> <?php if ($order['Status'] != 'Confirmed') { echo '| <a href="#" title="Confirm Order" onClick="confirm_tran();">CONFIRM ORDER</a>'; } ?> | <a href='#' title="Update Order Status" onClick="update_status();">CHANGE SHIP STATUS</a></p>
