<?php
$related_items = similar_files($file['FileName'], $file['FileID'], $file['FileCat'], $file['FilePrice']);
  ...
  <div class="span4">
	...
	<?php
	  if ($file['FileMethod'] === 'download') {
	    ...
	    $item_promo = '';
	    if ($file['FileMethod'] === 'ship' && $file['FileType'] == 0) {
	...
	<form name="buy_form" method="get">
	  <div class="well" style="padding:10px;">
		...
		<?php } ?>
	    <button type="submit" class="bit_btn add_btn"></button>
	  </div>
    </form>
    <?php } ?>
	<div style="margin-bottom:10px;">
  ...
  <div class="span12">
	...
	<div class="tabbable">
      <ul class="nav nav-tabs">
        <li class="active"><a href="#tab1" data-toggle="tab"><?php echo LANG('REVIEWS'); ?></a></li>
        <li><a href="#tab2" data-toggle="tab"><?php echo LANG('RELATED_PRODS'); ?></a></li>
      </ul>
