...
class Coinbase
{
	...
	const SAND_BASE = 'https://api.sandbox.coinbase.com/v1/';
    private $_rpc;
    ...
    {
        return $this->_rpc->request("GET", $this->baseURL().$path, $params);
    }

    public function post($path, $params=array())
    {
        return $this->_rpc->request("POST", $this->baseURL().$path, $params);
    }

    public function delete($path, $params=array())
    {
        return $this->_rpc->request("DELETE", $this->baseURL().$path, $params);
    }

    public function put($path, $params=array())
    {
        return $this->_rpc->request("PUT", $this->baseURL().$path, $params);
    }
